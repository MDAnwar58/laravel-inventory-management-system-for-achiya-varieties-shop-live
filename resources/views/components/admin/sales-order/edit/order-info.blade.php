    ...
    <div class="card mb-4">
        ...
        <div class="card-body pt-3">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="due-date" class="form-label fw-medium fs-5 mb-1">Due Date</label>
                    <input type="date" class="form-control fs-5" name="due_date" id="due-date" disabled />
                </div>

                <div class="col-md-12 mb-3">
                    <label for="status" class="form-label fw-medium fs-5 mb-1">Status</label>
                    <select class="form-select fs-5" name="status" id="status" disabled>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="notes" id="notes" class="form-control fs-5" rows="5" placeholder="Write notes..."
                        disabled></textarea>
                </div>
            </div>
        </div>
