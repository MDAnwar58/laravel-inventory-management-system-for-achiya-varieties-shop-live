            ...
            <div class="col-md-12 order-5">
                ...
                <div id="paid-amount-div" class="form-group d-none mb-3">
                    ...
                    <div class="input-group" style="width: 135px;">
                        <button type="button" class="paid-amount-edit-btn btn btn-sm btn-light border text-white text-secondary">
                            <i class="fa-solid fa-bangladeshi-taka-sign text-dark-emphasis" style="font-size: .85rem;"></i>
                        </button>
                        <input type="text" id="paid-amount-input" name="paid_amount" class="text-center form-control text-secondary">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 pt-3">
                    <button type="button" id="reset-all-btn" class="btn btn-danger px-2 text-uppercase d-flex justify-content-center align-items-center">
                        <i class="fa-solid fa-rotate fs-4"></i>
                    </button>
                    <button type="submit" class="btn btn-success text-uppercase fs-4 fw-semibold submit-btn">
                        <span class="fw-semibold">Order Create</span>
