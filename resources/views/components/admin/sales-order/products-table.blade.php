    ...
    <div class="card">
        <div id="card-title" class=" pt-3 px-4 d-flex flex-row justify-content-between align-items-center">
            ...
            <div class="d-flex gap-1">
                ...
                <button type="button" id="old-selected-products-btn" class="btn btn-sm btn-outline-primary rounded shadow-sm fs-5 fw-semibold d-none" data-bs-toggle="tooltip" data-bs-title="Clean All Selected Products.">
                ...
                <table class="table table-hover" id="productTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-muted fw-normal text-center">Retail Price Enable</th>
