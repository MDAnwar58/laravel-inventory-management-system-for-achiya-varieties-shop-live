    ...
    <div class="card">
        <div id="card-title" class=" pt-3 px-4 d-flex flex-sm-row flex-column justify-content-between align-items-center">
            ...
            <div class="d-flex gap-1">
                ...
                <button type="button" id="reset-customer-table-btn" class="btn btn-sm btn-light rounded shadow-sm fs-5 fw-semibold">
                    <i class="fa-solid fa-rotate-right"></i>
                </button>
                <button type="button" id="new-customer-add-btn" class="btn btn-sm btn-primary rounded shadow-sm fs-5 fw-semibold">
