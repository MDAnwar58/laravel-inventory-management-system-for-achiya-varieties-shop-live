    ...
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h5 class="card-title mb-0 fs-4 text-secondary">Product Edit</h5>
            </div>
            <form action="{{ route('admin.product.update', $data->id) }}" method="POST" enctype="multipart/form-data" class="card-body">
                @csrf
                <div class="pb-3">
                    <label for="name" class="form-label mb-1 text-muted">Product Name</label>
                    <div class="d-flex align-items-center gap-1">
                        <input type="text" name="name" value="{{ $data->name ?? '' }}" class="px-3 py-2 fs-5 form-control  custom-input  input" />
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-4 col-sm-6">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" id="price" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->price ?? '' }}" />
                                </div>
                        ...
                        {{-- <div class="col-xl-3 col-md-4 col-sm-6 mt-sm-0 mt-3">
                            <div class="input-group">
                                ...
                                <input type="number" name="discount_price" class="px-3 py-2 fs-5 form-control  custom-input  input" placeholder="Discount price" value="{{ $data->discount_price ?? '' }}" />
                            </div>
                        </div> --}}
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-md-0 mt-3">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="retail_price" id="retail_price" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->retail_price ?? '' }}" />
                                </div>
                                <span class="text-warning fs-3">*</span>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-xl-0 mt-3">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="cost_price" id="cost_price" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->cost_price ?? '' }}" />
                                </div>
                                <span class="text-danger fs-3">*</span>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-xl-0 mt-3">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="stock" id="stock" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->stock ?? '' }}" {{ $data->stock_w_type != 'none' ? 'disabled' : '' }} />
                                </div>
                                <span class="text-warning fs-3">*</span>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-3">
                            <label for="stock" class="form-label mb-1 text-muted">Stock Weight/Foot/Yard/Meter</label>
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    <span class="input-group-text fs-4 fw-bold">
                                        <i class="fa-solid fa-hashtag fs-6"></i>
                                    </span>
                                    <input type="text" name="stock_w" id="stock_w" class="px-3 py-2 fs-5 form-control  custom-input  input" step="0.01" value="{{ $data->stock_w_type == 'ft' || $data->stock_w_type == 'yard' || $data->stock_w_type == 'm' ? number_format((float)$data->stock_w, 2, '.', '') : $data->stock_w ?? '' }}" {{ $data->stock_w_type == 'none' ? 'disabled' : '' }} />
                                    <select name="stock_w_type" id="stock_w_type" class=" border-secondary-subtle text-secondary rounded-end-2">
                                        <option value="none" {{ $data->stock_w_type == 'none' ? 'selected' : '' }}>None</option>
                                        <option value="kg" {{ $data->stock_w_type == 'kg' ? 'selected' : '' }}>Kg</option>
                                        <option value="ft" {{ $data->stock_w_type == 'ft' ? 'selected' : '' }}>Ft</option>
                                        <option value="yard" {{ $data->stock_w_type == 'yard' ? 'selected' : '' }}>Yard</option>
                                        <option value="m" {{ $data->stock_w_type == 'm' ? 'selected' : '' }}>Meter</option>
                                    </select>
                                </div>
                                <span class="text-warning fs-3">*</span>
                            </div>
                            <x-error fieldName="stock_w" />
                        </div>
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-3">
                            <label for="stock" class="form-label mb-1 text-muted">Low Stock Level</label>
                            <div class="d-flex align-items-center gap-1">
                                <div class="input-group">
                                    <span class="input-group-text fs-4 fw-bold">
                                        <i class="fa-solid fa-hashtag fs-6"></i>
                                    </span>
                                    <input type="text" name="low_stock_level" id="low_stock_level" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->low_stock_level ?? '' }}" />
                                </div>
                                <span class="text-warning fs-3">*</span>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-6 mt-3">
                            <label for="stock" class="form-label mb-1 text-muted">Purchase Limit</label>
                            <div class="input-group">
                                <span class="input-group-text fs-4 fw-bold">
                                    <i class="fa-solid fa-hashtag fs-6"></i>
                                </span>
                                <input type="number" name="purchase_limit" id="purchase_limit" class="px-3 py-2 fs-5 form-control  custom-input  input" value="{{ $data->purchase_limit ?? '' }}" />
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="pb-3">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <select name="item_type_id" class="px-3 py-2 fs-5 form-select focus-ring-none">
                                    ...
                                    <option value="{{ $item_type->id }}" {{ $item_type->id == $data->item_type_id ? 'selected' : '' }}>
                                        {{ $item_type->name }}
                                    </option>
                                    @endforeach
                                    @else
                    ...
                    <div class="col-md-6">
                        <div class="pb-3">
                            ...
                            <select name="brand_id" class="px-3 py-2 fs-5 form-select focus-ring-none">
                                ...
                                <option value="{{ $brand->id }}" {{ $brand->id == $data->brand_id ? 'selected' : '' }}>{{ $brand->name }}
                                </option>
                                @endforeach
                                @else
                    ...
                    <div class="col-md-6">
                        <div class="pb-3">
                            <label for="category_id" class="form-label mb-1 text-muted">Category</label>
                            <div class="d-flex align-items-center gap-1">
                        ...
                        <div class="pb-3">
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <select name="sub_category_id" class="px-3 py-2 fs-5 form-select focus-ring-none">
                                    ...
                                    <option value="{{ $sub_category->id }}" {{ $sub_category->id == $data->sub_category_id ? 'selected' : '' }}>{{ $sub_category->name }}</option>
                                    @endforeach
                                    @else
                ...
                <div class="pb-3">
                    ...
                    <div id="image-prev-div" class="d-flex {{ $data->image ? 'pb-2' : '' }}">
                        <div class="position-relative">
                            <button type="button" id="remove-btn" class="btn btn-sm btn-outline-danger rounded-3 position-absolute top-0 end-0 me-3 mt-2 {{ $data->image ? '' : 'd-none' }}">
                                <i class="feather-sm" data-feather="x"></i>
                            </button>
                            <img id="image-prev" src="{{ $data->image }}" class="rounded-circle {{ $data->image ? '' : 'd-none' }}" style=" width: 151px; height: 151px;" />
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        stock.addEventListener('input', e => {
         ...
         stockW.addEventListener('input', e => {
            console.log(stockWType.value === 'yard');
            ...
            else writeOnlyNumberAndDecimalInput(e.currentTarget)
        });
