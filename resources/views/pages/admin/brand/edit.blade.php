    ...
    <div class="col-md-12">
      <div class="card shadow-sm">
        <div class="card-header pb-0">
          <h5 class="card-title mb-0 fs-4">Brand Edit</h5>
        </div>
        <form action="{{ route('admin.brand.update', $data->id) }}" method="POST" enctype="multipart/form-data"
          ...
          <div class="pb-3">
            <div id="image-prev-div" class="d-flex {{ $data->image ? 'pb-3' : '' }}">
              <div class="position-relative">
                ...
                <img id="image-prev" src="{{ $data->image }}" class="{{ $data->image ? '' : 'd-none' }}" style=" width: 151px; height: 151px;" />
              </div>
            </div>
