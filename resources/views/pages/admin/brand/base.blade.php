...
@section('content')
  <x-admin.breadcrumb :breadcrumbs="$breadcrumbs" :create_btn_name="'Create'" :btn_route="'admin.brand.create'" />
  <x-admin.page-title title="Brand" />
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="datatable-wrapper">
                <!-- Header -->
                <x-admin.datatable-header :filters="$filters" />  
                ...
                html += `<tr>
                    ...
                    <td>
                        <div class="d-flex gap-1 align-items-center">
                            <a href="/admin/brand/edit/${data.id}" class="btn btn-sm btn-outline-primary pt-2 pb-1 rounded-3"><i class="fa-solid fa-pen-to-square fs-5"></i></a>
                            <button type="button" data-url="/admin/brand/delete/${data.id}" class="btn btn-sm btn-outline-danger delete-btn pt-2 pb-1 rounded-3 ${deleteOptionIsLock ? 'disabled' : ''}"><i class="fa-solid fa-trash fs-5"></i></button>
                        </div>
                    </td>
                </tr>`;
            });
        ...
        $.get(baseUrl + url)
            .done(function(res) {
                if (res.status === 'success') {
                    ...
                    processNotify(res.msg, res.status); // Replace with your notify
                    page = p;
                    getData(search, filter, sortColumn, sort, page, perPage);
                } else {
